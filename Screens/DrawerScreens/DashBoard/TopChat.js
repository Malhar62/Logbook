...
import { dashWidth } from '../../Functions';
    ...
    return (
        <View style={{ backgroundColor: '#f1f1f1', marginTop: 10 }}>
            ...
            elevation={5} style={styles.view}>
             ...
             <ScrollView  showsHorizontalScrollIndicator={false}
             horizontal={true}
             elevation={5} style={[styles.view, { marginVertical: 10 }]}>
            ...
            horizontal={true} elevation={5} style={[styles.view,{marginBottom:10}]}>
                <View style={styles.view1}>
...
const styles = StyleSheet.create({
    view:
        { width: dashWidth(), height: 90, flexDirection: 'row', borderRadius: 10, backgroundColor: '#fff', alignSelf: 'center' },
    view1:
